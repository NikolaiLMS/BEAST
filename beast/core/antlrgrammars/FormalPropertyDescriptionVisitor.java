...
public interface FormalPropertyDescriptionVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link FormalPropertyDescriptionParser#posExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPosExpression(FormalPropertyDescriptionParser.PosExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link FormalPropertyDescriptionParser#voterPosExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVoterPosExp(FormalPropertyDescriptionParser.VoterPosExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link FormalPropertyDescriptionParser#candPosExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCandPosExp(FormalPropertyDescriptionParser.CandPosExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link FormalPropertyDescriptionParser#seatPosExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSeatPosExp(FormalPropertyDescriptionParser.SeatPosExpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FormalPropertyDescriptionParser#passInt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPassInt(FormalPropertyDescriptionParser.PassIntContext ctx);
	/**
